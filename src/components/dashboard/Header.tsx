        ...
        <div className="flex items-center gap-4 sm:gap-6">
                ...
                <div className="overflow-y-auto scrollbar-thin" style={{ maxHeight: "340px" }}>
                  {notifications.length === 0 ? (
                    ...
                    notifications.map((notif) => (
                      <div
                        key={notif.id}
                        className={`group relative flex gap-3 px-5 py-4 border-b border-white/5 last:border-0 transition-colors ${notif.read ? "opacity-60" : "bg-white/[0.02]"
                          } hover:bg-white/5`}
                      >
                        {/* Type dot */}
          ...
          <div className="relative" ref={profileRef}>
            ...
            >
              ...
              <ChevronDown
                size={15}
                className={`hidden sm:block text-text-secondary transition-transform duration-200 ${profileOpen ? "rotate-180" : ""
                  }`}
              />
            </button>

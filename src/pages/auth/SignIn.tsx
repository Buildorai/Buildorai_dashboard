...
export default function SignIn() {
  ...
  // Redirect to the page they were trying to visit, or overview
  ...
  return (
    <div className="relative h-[100dvh] w-full overflow-y-auto overflow-x-hidden bg-[#020617] text-white font-sans selection:bg-primary/30 scrollbar-thin">
      ...
      <div className="fixed inset-0 z-0 pointer-events-none">
        ...
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,rgba(14,165,233,0.15),transparent_80%)]" />
        
        {/* Deep Primary Glow Orb 1 */}
        <motion.div 
          animate={{ 
            opacity: [0.5, 0.7, 0.5],
            scale: [1, 1.2, 1],
          ...
          className="absolute -top-[10%] -left-[10%] h-[70%] w-[70%] rounded-full bg-primary/30 blur-[120px]"
        />
        ...
        <motion.div 
          ...
          className="absolute -bottom-[20%] -right-[10%] h-[80%] w-[80%] rounded-full bg-primary/20 blur-[150px]"
        />
        ...
        >
          ...
          <div className="mb-10 flex flex-col items-center text-center">
            ...
            <p className="mt-2 text-text-secondary">
              Synchronize with the neural orchestration core.
            </p>
          </div>

          {/* Login Card */}
          <div className="relative overflow-hidden rounded-[2.5rem] border border-white/10 bg-white/[0.03] p-4 md:p-8 backdrop-blur-3xl shadow-2xl">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                <label className="text-xs font-bold uppercase tracking-[0.2em] text-text-secondary px-1">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between px-1">
                  <label className="text-xs font-bold uppercase tracking-[0.2em] text-text-secondary">
                    Access Key
                  </label>
                </div>
                <div className="group relative">
              ...
              <motion.button
                ...
                type="submit"
                disabled={isLoading}
                className="relative flex w-full items-center justify-center overflow-hidden rounded-2xl bg-primary px-8 py-4 text-sm font-bold text-white shadow-lg shadow-primary/20 transition-all hover:bg-primary-dark disabled:opacity-70 group"
              >
            ...
            {/* Divider */}
            <div className="my-8 flex items-center gap-4 text-text-secondary">
              <div className="h-[1px] flex-1 bg-white/10" />
              <span className="text-[10px] uppercase tracking-[0.2em] font-bold">Standard Uplink</span>
              <div className="h-[1px] flex-1 bg-white/10" />
            </div>
            ...
            <div className="grid grid-cols-1">
              <motion.button 
                ...
                disabled={isLoading}
                className="flex items-center justify-center gap-3 rounded-2xl border border-white/5 bg-white/5 py-4 text-sm font-medium text-white transition-all hover:bg-white/10 disabled:opacity-70"
              >
          ...
          <div className="my-4 text-center text-sm">
            <span className="text-text-secondary">New to the core? </span>
            <Link to="/signup" className="font-bold text-primary hover:text-white transition-colors">
              Generate Identity
            </Link>
          </div>
        </motion.div>
